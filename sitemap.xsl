	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
					Generated with <a href="http://reloadcms.com/" title="Google Sitemap Generator Plugin for ReloadCMS">Google Sitemap Generator Plugin for ReloadCMS</a> by <a href="http://fromgomel.com/">Den1xxx</a>. This XSLT template is released under GPL.
				</div>
			</body>
		</html>
	</xsl:template>
