...
$container = empty($articles->config['lcmt'])?'articles':$articles->config['lcmt'];
if(!$articles->setWorkContainer($container)) 
return show_window(__('Recently commented articles'),__('Error occurred').':<br />'.$articles->last_error);
