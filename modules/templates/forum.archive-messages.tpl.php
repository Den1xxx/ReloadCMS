...
<tr>
    <td align="left" class="row2">
        &nbsp;&nbsp;&gt; <a href="?module=forum.archive"><?=__('Topics list')?></a>
        &gt; <?=$tpldata['topic']['title']?>
    </td>
    <td align="right" class="row2">
	        [ <a href="?module=forum"><?=__('In').' '.__('Forum')?></a> ]
    </td>
</tr>
</table>
<br />
<div align="right">
    <?=rcms_pagination(sizeof($tpldata['posts']), $system->config['perpage'], $page + 1, '?module=forum.archive&amp;action=topic&amp;id=' . $tpldata['topic']['id'])?>
</div>
...
<tr style="height:10px">
    ...
    <td class="row2" align="right" nowrap="nowrap">
        <small>
            ...
            [ <a href="?module=forum.archive&amp;action=restore_topic&amp;t=<?=$tpldata['topic']['id']?>"><?=__('Restore')?></a> ]
            <?php } ?>
            ...
            [ <a href="?module=forum.archive&amp;action=del_topic&amp;t=<?=$tpldata['topic']['id']?>"><?=__('Delete')?></a> ]
            <?php } ?>
        </small>
    </td>
</tr>
...
<tr style="height:10px">
    ...
    <td class="row2" align="right" nowrap="nowrap">
        <small>
            ...
            <?php } ?>
            <?php if($system->checkForRight('FORUM')){ ?>
            [ <a href="?module=forum.archive&amp;action=restore_topic&amp;t=<?=$tpldata['topic']['id']?>&amp;p=<?=$post_id + 2?>"><?=__('Restore')?></a> ]
            [ <a href="?module=forum.archive&amp;action=del_post&amp;t=<?=$tpldata['topic']['id']?>&amp;p=<?=$post_id + 2?>"><?=__('Delete')?></a> ]
            <?php } ?>
        </small>
    </td>
</tr>
