...
<tr style="height:10px">
    ...
    <td class="row2" align="right" nowrap="nowrap">
        <small>
            <?php if(($tpldata['topic']['author_name'] != 'guest') AND (LOGGED_IN)){ ?>
            ...
            [ <a href="?module=forum&amp;action=arch_topic&amp;t=<?=$tpldata['topic']['id']?>"><?=__('In').' '.__('Archive')?></a> ]
            <?php } ?>
        </small>
    </td>
</tr>
...
<tr style="height:10px">
    ...
    <td class="row2" align="right" nowrap="nowrap">
        <small>
            <?php if(($post['author_name'] != 'guest') AND (LOGGED_IN)){ ?>
